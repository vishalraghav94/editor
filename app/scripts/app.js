...
App = (function() {
    ...
    function App() {
        ...
        this.onChangeLang = bind(this.onChangeLang, this);
        ...
        this.editor = this.setupAce('ace/mode/javascript');
        this.loadContent();
        this.editor.focus();
        ...
        $(".language-selector").on('change', this.onChangeLang);
    ...
    App.prototype.setupAce = function(languageMode) {
        var editor;
    ...
    App.prototype.onChangeLang = function () {
        ...
        this.editor = this.setupAce(value);
    };
    ...
    App.prototype.onClickDownload = function() {
        ...
        $a = $("<a>").attr({
            ...
            href: window.URL.createObjectURL(new Blob([this.editor.getValue()], {
                type: "text/txt"
            }))
        }).appendTo("body");
        return $a[0].click();
